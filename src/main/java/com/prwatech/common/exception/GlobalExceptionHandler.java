...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ResponseMessage> handleUnProcessableException(
        ...
        HttpResponse errorResponse =
                new HttpResponse(HttpStatus.UNPROCESSABLE_ENTITY, unProcessableEntityException.getMessage());
        return new ResponseEntity<>(new ResponseMessage(ERROR, errorResponse), HttpStatus.UNPROCESSABLE_ENTITY);
    }
    ...
    public ResponseEntity<ResponseMessage> handleNotFoundException(NotFoundException notFoundException){
        HttpResponse errorResponse = new HttpResponse(HttpStatus.NOT_FOUND, notFoundException.getMessage());
    ...
    public ResponseEntity<ResponseMessage> handleAlreadyPresentException(AlreadyPresentException alreadyPresentException){

        HttpResponse errorResponse = new HttpResponse(HttpStatus.ALREADY_REPORTED, alreadyPresentException.getMessage());

        LOGGER.error(alreadyPresentException.getMessage(), alreadyPresentException);
        return new ResponseEntity<>(new ResponseMessage(ERROR, errorResponse) , HttpStatus.ALREADY_REPORTED);
    }
}
